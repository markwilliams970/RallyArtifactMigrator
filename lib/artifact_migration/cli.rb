...
module ArtifactMigration
	class CLI
		...
		def setup_import
			...
			[:end_type_import, :end_update_story_parents, :end_update_story_predecessors, :end_update_artifact_statuses, :end_test_folder_reparent, :end_update_defect_duplicates, :end_attachment_import].each do |event|
			...
			[:import_type_count, :begin_update_story_parents, :begin_update_story_predecessors, :begin_test_folder_reparent, :begin_update_defect_duplicates, :begin_attachment_import].each do |event|
